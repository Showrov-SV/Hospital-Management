...
public class Signup {
    ...
    private void createSignupWindow() {
        ...
        frame.setSize(420, 300); // slightly bigger, like login
        ...
        // Title
        JLabel title = new JLabel("Admin Sign Up", JLabel.CENTER);
        ...
        // Buttons arranged horizontally like login
        DarkNeonButton signupBtn = new DarkNeonButton("Sign Up");
        DarkNeonButton loginBtn = new DarkNeonButton("Back to Login");
        ...
        signupBtn.addActionListener(e -> {
            ...
            try {
                ...
                ps.executeUpdate();
                showMessage(frame, "Signup successful! Please login.", true);
                frame.dispose();
                new Login(connection);
            } catch(SQLException ex) {
                showMessage(frame, "Signup failed: " + ex.getMessage(), false);
            }
        });
    ...
    // Custom message popup like dark neon style
    private void showMessage(JFrame parent, String msg, boolean success) {
        JDialog dialog = new JDialog(parent, "Message", true);
        dialog.setSize(380, 160); // taller and wider
        dialog.setLocationRelativeTo(parent);
        dialog.setLayout(new BorderLayout());

        JPanel panel = new JPanel();
        panel.setBackground(new Color(20, 20, 20));
        panel.setBorder(BorderFactory.createEmptyBorder(20, 20, 20, 20)); // more space around text
        panel.setLayout(new BorderLayout());

        JLabel label = new JLabel("<html><div style='text-align:center;'>" + msg + "</div></html>", JLabel.CENTER);
